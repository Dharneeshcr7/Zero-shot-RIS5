...
from old_detectron2.detectron2.layers import ShapeSpec, batched_nms
from old_detectron2.detectron2.structures import Boxes, ImageList, Instances, pairwise_point_box_distance
